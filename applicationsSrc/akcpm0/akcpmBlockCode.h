...
static const int AKCPM_MSG_ENCRYPTED_DATA = 2003;
...
public:
    ...
    // ✅ AJOUT: Handlers de messages (doivent être publics pour être appelés)
...
public:
    ...
    uint64_t n1;
    uint64_t x;
    bool isStructureMessage;
    
    MembershipProofMessage(int hops, uint64_t _n1, uint64_t _x, bool structMsg);
